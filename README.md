...
- [FeatherWings](#featherwings-adafruit)
...
| [Adafruit ESP32-C6 Feather](https://www.adafruit.com/product/5933) | WiFi 6, Bluetooth 5 (LE) & 802.15.4 protocol | - | - | - | - | - | - | WiFi, BTLE 5, 802.15.4 |
...
| Renesas | [RA8M1 Feather SoM](https://github.com/Zalmotek/renesas-RA8M1-feather) | 480MHz Arm Cortex-M85 Based Microcontroller with Helium and TrustZone |
...
| [Würth Elektronik](https://www.we-online.de/) | [Sensor FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/SensorFeatherWing) | 4-sensor FeatherWing with temperature, humidity, absolute pressure, 3-axis acceleration [sensors](https://www.we-online.com/en/components/products/sens/sensors_product_group). |
| Würth Elektronik | [Setebos-I Wireless FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/Setebos-I_FeatherWing) | A combination of Bluetooth® LE 5.1 and proprietary 2.4 GHz radio from the [Setebos-I](https://www.we-online.com/en/components/products/SETEBOS-I) radio module, with integrated secure element. |
| Würth Elektronik | [Calypso Wi-Fi FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/CalypsoWiFiFeatherWing) | 2.4 GHz WiFi connectivity with support for SNTP, HTTP(S), MQTT(S) and cloud connectivity, powered by the [Calypso](https://www.we-online.com/en/components/products/CALYPSO) WiFi module.  |
| Würth Elektronik | [Adrastea-I FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/AdrasteaFeatherWing) | LTE-M/NB-IoT cellular connectivity with integrated GNSS functionality, powered by the [Adrastea-I](https://www.we-online.com/en/components/products/ADRASTEA-I) module.|
| Würth Elektronik | [Daphnis-I FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/DaphnisILoRaWANFeatherWing) | Ultra-low-power, long range Sub-GHz LoRaWAN® 1.0.4 (Class A/B/C) and proprietary P2P, star, and mesh connectivity, powered by [Daphnis-I](https://www.we-online.com/en/components/products/DAPHNIS-I).|
| Würth Elektronik | [ICLEDFeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/ICLEDFeatherWing) | 7x15 ICLED matrix with individually programmable [IC LEDs](https://www.we-online.com/en/components/products/WL-ICLED?sq=1312020030000#1312020030000)  |
...
| Würth Elektronik | [Serial bridge FeatherWing](https://github.com/WurthElektronik/FeatherWings/tree/main/SerialFeatherWing) | RS232/RS485 to UART bridge.|
| Würth Elektronik | [SensorBLE FeatherWing Kit](https://www.we-online.com/en/components/products/SENSOR_BLE__FEATHERWING_KIT_2) | Build your own sensor node that [transmits sensor data](https://github.com/WurthElektronik/FeatherWings/tree/main/Sensor2BLE) via Bluetooth® LE 5.1 to your smart device. Visualize the data using an [open source app](https://github.com/WurthElektronik/WE-SensorBLE).|
| Würth Elektronik | [Adrastea-I FeatherWing Kit](https://www.we-online.com/en/components/products/ADRASTEA-I_FEATHERWING_KIT_2) | Build your sensor-to-cloud cellular [IoT application](https://github.com/WurthElektronik/Adrastea-FeatherWing-Kit) that sends sensor data to any IoT platform of your choice. |
| Würth Elektronik | [Calypso IoT design Kit](https://www.we-online.com/en/components/products/CALYPSO_IOT_FEATHERWING_2) | Build your sensor-to-cloud [IoT application](https://github.com/WurthElektronik/Calypso-IoT-PnP-Design-Kit) that sends sensor data via WiFi to any IoT platform of your choice. |
...
- [The 2019 Take Flight with Feather Contest](https://hackaday.io/contest/168107-take-flight-with-feather) - sponsored by Hackaday, DigiKey, and Adafruit which sought manufacturable boards in several categories. [Here are the winners]( https://hackaday.com/2020/01/22/winners-of-the-take-flight-with-feather-contest/).
